...
(function () {    
    ...
    var Skippr = (function () {
        ...
        Skippr.prototype.change = function(element) {
            ...
            if(ban_fag%2){
                $(".bannerRight2").hide();
                $(".bannerRight1").fadeIn(1000);
            }
            else{
                $(".bannerRight1").hide();
                $(".bannerRight2").fadeIn(1000);
            }
...
(function () {    
    ...
    var Skippr2 = (function () {

        function Skippr2(element, options) {
        ...
        Skippr2.prototype.init = function() {
        ...
        Skippr2.prototype.setup = function() {
        ...
        Skippr2.prototype.resize = function() {
        ...
        Skippr2.prototype.arrowBuild = function() {
        ...
        Skippr2.prototype.navBuild = function() {
        ...
        Skippr2.prototype.arrowClick = function() {
        ...
        Skippr2.prototype.navClick = function() {
            ...
            ban_fag = 0;
        Skippr2.prototype.change = function(element) {
            // 改变右侧展示框样式
        ...
        Skippr2.prototype.autoPlay = function() {
        ...
        Skippr2.prototype.autoPlayPause = function() {
            var _ = this;
        ...
        Skippr2.prototype.setupSlider = function() {
        ...
        Skippr2.prototype.keyPress = function() {
        ...
        Skippr2.prototype.hidePrevious = function() {
        ...
        Skippr2.prototype.logs = function(message) {
    ...
    $.fn.skippr2 = function (options) {

        var instance;

        instance = this.data('skippr2');
        if (!instance) {
            return this.each(function () {
                return $(this).data('skippr2', new Skippr2(this,options));
            });
        }
        if (options === true) return instance;
        if ($.type(options) === 'string') instance[options]();
...
(function () {    
    ...
    var Skippr3 = (function () {

        function Skippr3(element, options) {
        ...
        Skippr3.prototype.init = function() {
        ...
        Skippr3.prototype.setup = function() {
        ...
        Skippr3.prototype.resize = function() {
        ...
        Skippr3.prototype.arrowBuild = function() {
        ...
        Skippr3.prototype.navBuild = function() {
        ...
        Skippr3.prototype.arrowClick = function() {
        ...
        Skippr3.prototype.navClick = function() {
            ...
            ban_fag = 0;
        Skippr3.prototype.change = function(element) {
            // 改变右侧展示框样式
        ...
        Skippr3.prototype.autoPlay = function() {
        ...
        Skippr3.prototype.autoPlayPause = function() {
            var _ = this;
        ...
        Skippr3.prototype.setupSlider = function() {
        ...
        Skippr3.prototype.keyPress = function() {
        ...
        Skippr3.prototype.hidePrevious = function() {
        ...
        Skippr3.prototype.logs = function(message) {
    ...
    $.fn.skippr3 = function (options) {

        var instance;

        instance = this.data('skippr3');
        if (!instance) {
            return this.each(function () {
                return $(this).data('skippr3', new Skippr3(this,options));
            });
        }
        if (options === true) return instance;
        if ($.type(options) === 'string') instance[options]();
